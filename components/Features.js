            ...
            {features.map((feature) => (
              <div key={feature.name} className="py-6">
                <div className="flow-root px-10 pb-8 mx-6 bg-white shadow-lg h-60 shadow-neutral-500/50 lg:mx-0 md:mx-32 ">
                  <FadeIn>
                    <h3 className="text-xl font-medium tracking-tight underline pt-9 md:pt-12 md:text-2xl text-neutral-900 ">
                      {feature.name}
                    </h3>
                    <p className="mt-4 text-base md:text-lg text-neutral-900 ">
                      {feature.description}
                    </p>
                  </FadeIn>
                </div>
