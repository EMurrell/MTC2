export default function About() {
  return (
    <section
      id="About"
      className="flex flex-col justify-center w-full px-8 tracking-tight md:py-8 font-display "
    >
      ...
      <div className="flex flex-col justify-center px-8 py-4 mt-10 text-lg font-normal text-center text-white border-4 shadow-lg bg-highlight1 place-self-center md:text-xl lg:text-2xl border-highlight1 shadow-neutral-900/70">
        <h2>
